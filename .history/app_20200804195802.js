...
const Notification = require("./service/notification/controller");

const db = require("./db/mongodb");
db.init();

const conn1 = require("./service/salesforce");
console.log(conn1.con.accessToken);
...
app.route("/pushnotification").post(function(req, res) {
  process.env.BASE_URL = "https://" + req.headers.host;
  Notification.processRequest(req);
  res.send("SUCCESS");
});
