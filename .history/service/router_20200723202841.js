...
exports.processEvent = async (event) => {
  ...
  } else if ((event.type == "message" || event.type == "postback") && terminal.originId == terminal.terminal.id) {
    let instance = await SERVICES[SERVICE_NAME.DEFAULT].initInstance(event);
    await updateTerminal(terminal.originId, instance);
  }
...
exports.deleteRouteByTerminal = async (id) => {
