...
const createEvent = async (profile, event) => {
  ...
  if (event.type === "message") {
    ...
    conn.login("alican.taner@brave-bear-446336.com", "taner110490", function(err, res) {
      if (err) {
      ...
      conn
        ...
        .find(
          ...
          { LastName: { $like: "A%" }, CreatedDate: { $gte: jsforce.Date.YESTERDAY }, "Account.Name": "Sony, Inc." },
          // fields in JSON object
          { Id: 1, Name: 1, CreatedDate: 1 }
        )
                ...
                actions: [
                  {
                    ...
                    label: "Account Link",
                    uri:
                      "https://brave-bear-446336-dev-ed--c.ap4.visual.force.com/apex/tes?linkToken=" +
