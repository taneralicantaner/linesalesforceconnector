  ...
  return new Promise((resolve, reject) => {
    request.post(options, (error, response, body) => {
      if (error || response.statusCode != 200) {
                ...
                actions: [
                  {
                    ...
                    label: "Account Link",
                    uri:
                      "https://brave-bear-446336-dev-ed--c.ap4.visual.force.com/apex/tes?linkToken=" + body.linkToken,
                  },
                ],
              },
            },
        ...
        console.log("https://brave-bear-446336-dev-ed--c.ap4.visual.force.com/apex/tes?linkToken=" + body.linkToken);
        console.log(body.get("linkToken"));
